<?php return array (
  ...
  'plugin.generic.customBlockManager.introduction' => 'You can use this plugin to add or delete custom block plugins.  You can then edit the content through the <a href="{$systemPluginsUrl}">System Plugins</a> page (in the Blocks Plugin section).  To place your plugin in the desired location in the sidebar, go to <a href="{$setupStep4}">Setup step 4</a>',
  ...
  'plugins.generic.customBlock.contentRequired' => 'Some content is required.  If you wish you delete this block, you can do so with the Block Manager Plugin or by deselecting this block in Step 5 of the setup.',
